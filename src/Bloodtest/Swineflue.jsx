...
import placeholderimage from "../img/swine flu-placeholder.jpg";
...
const validationSchema = Yup.object({
  ...
  mobileNo: Yup.string().matches(/^[0-9]+$/, "Must be a number").required("Mobile number is required"),
