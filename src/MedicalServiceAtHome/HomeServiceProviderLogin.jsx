...
function HomeServiceProvider() {
  ...
  const handleSubmit2 = async (values) => {
    try {
      ...
      await axios
        .post(
          `${process.env.REACT_APP_API_URL_GRACELAB}/api/auth/login/service-provider`,
          values
        )
        .then((res) => {
          ...
          if (res.data.isOk === false) {
            ...
            Cookies.set("homeServiceProviderId", res.data.data._id, {
              expires: 7,
            });
            Swal.fire({
              title: "Success!",
              ...
              navigate(
                `/medical-services/service-provider/${res.data.data._id}`
              );
            });
          }
        });
              ...
              <div className="login-wrap p-4 p-md-5">
                ...
                <div className="w-100 text-center mt-4">
                  <p className="text-center">
                    ...
                    <Link
                      to="/medical-services/service-provider-register"
