...
const validationSchema = Yup.object({
  ...
  ServiceProvider: Yup.string().required("Reference Number is required"),
...
function Vendorsignup() {
  ...
  const handleSubmit2 = async (values) => {
    try {
      ...
      await axios
        .post(
          `${process.env.REACT_APP_API_URL_GRACELAB}/api/auth/service-provider`,
          values
        )
        .then((res) => {
          ...
          if (res.data.isOk === false) {
            ...
            Swal.fire({
              ...
              window.location.reload(
                `/medical-services/service-provider-register`
              );
            });
          }
        });
    ...
    <>
      ...
      <div className="page-title-area">
        <Pagetitle
          ...
          pagetitlelink=">"
          title1="Signup"
          title2="Medical Services At Home"
