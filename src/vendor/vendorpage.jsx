...
function Vendorpage() {
  ...
  const handleSubmit2 = async (values) => {
    try {
      ...
      await axios
        .put(
          `${
            process.env.REACT_APP_API_URL_GRACELAB
          }/api/auth/updateVendor/${Cookies.get("vendorId")}`,
          formData,
          {
            headers: {
  ...
  const getProfile = async () => {
    try {
      setIsLoadToggle(true);
      setToggleAddProduct(false);
      // if(!toggle){
      const res = await axios.get(
        `${
          process.env.REACT_APP_API_URL_GRACELAB
        }/api/auth/getVendor/${Cookies.get("vendorId")}`
      );
      if (res.data) {
        console.log("get vendnor", res);
        setInitialValue((prevValues) => ({
          ...prevValues,
          VendorName: res.data.VendorName || "",
          VendorReferenceNo: res.data.VendorReferenceNo || "",
          VendorRegistrationDate: res.data.VendorRegistrationDate || "",
          ShopName: res.data.ShopName || "",
          VendorLicenseNumber: res.data.VendorLicenseNumber || "",
          VendorLicenseDate: res.data.VendorLicenseDate || "",
          mobileNumber: res.data.mobileNumber || "",
          EmailPersonal: res.data.EmailPersonal || "",
          EmailShop: res.data.EmailShop || "",
          Password: res.data.Password || "",
          Speciality: res.data.Speciality || "",
          area: res.data.area || "",
          city: res.data.city || "",
          address: res.data.address || "",
          //   Vendorphoto: res.data.Vendorphoto || null,
          //   UploadFile: res.data.UploadFile || null,
          IsActive: res.data.IsActive || false,
        }));
        console.log(res.data.UploadFile);
        setFile(res.data.Vendorphoto || null);
        setPdf(res.data.UploadFile || null);
                ...
                <div className="login-wrap p-4 p-md-5">
                  <div className="d-block">
                    <div className="w-100 text-center">
                      <h3 className="mb-4 h5 fw-bold">Vendor Profile</h3>
                          ...
                          <Row className="justify-content-center">
                            ...
                            <Col lg={4} className="form-group mb-3">
                              ...
                              <Form.Control
                                ...
                                isInvalid={
                                  touched.EmailShop && errors.EmailShop
                                }
                              />
                              <Form.Control.Feedback type="invalid">
                                {errors.EmailShop}
                              ...
                              {file || photoadd ? (
                                <img
                                  ...
                                  src={
                                    checkImagePhoto
                                      ? photoadd
                                      : `${process.env.REACT_APP_API_URL_GRACELAB}/${file}`
                                  }
                                  width="180"
                                  height="200"
                                />
                            ...
                            <Col lg={6} className="form-group mb-3">
                              ...
                              <div style={{ paddingTop: "10px" }}>
                                {pdf && !pdfupload && (
                                  <a
                                    href={`${process.env.REACT_APP_API_URL_GRACELAB}/${pdf}`}
                                    target="_blank"
                            ...
                            >
                              {isLoading ? "Submitting..." : "Update Now"}
                            </Button>
                          </Row>
                        </div>
                      </Form>
